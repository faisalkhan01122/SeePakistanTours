...
const CarRentalspage = () => {
  ...
  const cars = [
    {
      ...
      image: "https://seepakistantours.com/wp-content/uploads/2018/02/Honda-City-Aspire-2015-01-390x293.jpg",
      link: "#"
    },
    {
      id: 2,
      ...
      price: "5,000 Rs/- Per Day",
      image: "https://seepakistantours.com/wp-content/uploads/2018/02/Toyota-Corolla-GLI-2014-16-01-390x293.jpg",
      link: "#"
    },
    {
      id: 3,
      ...
      image: "https://seepakistantours.com/wp-content/uploads/2018/02/Toyota-Corolla-GLI-2017-19-02-390x293.jpg",
      link: "#"
    },
    {
      id: 4,
      ...
      image: "https://seepakistantours.com/wp-content/uploads/2018/02/Honda-BR-V-2018-19-02-390x293.jpg",
      link: "#"
    },
    {
      id: 5,
      ...
      image: "https://seepakistantours.com/wp-content/uploads/2018/02/Toyota-Grand-Cabin-2014-17-01-390x293.jpg",
      link: "#"
    },
    {
      id: 6,
      ...
      image: "https://seepakistantours.com/wp-content/uploads/2019/11/Suzuki-APV-01-390x293.jpg",
      link: "#"
    },
    {
      id: 7,
      ...
      image: "https://seepakistantours.com/wp-content/uploads/2023/01/prado-2007.jpg",
      link: "#"
    },
    {
      id: 8,
      ...
      image: "https://seepakistantours.com/wp-content/uploads/2018/02/Toyota-Prado-2014-2015-01-390x293.jpg",
      link: "#"
    },
    {
      id: 9,
      ...
      image: "https://seepakistantours.com/wp-content/uploads/2018/02/Toyota-Prado-2018-01-390x293.jpg",
      link: "#"
    },
    {
      id: 10,
      ...
      image: "https://seepakistantours.com/wp-content/uploads/2018/02/Toyota-Saloon-Coaster-2013-02-390x293.jpg",
      link: "#"
    },
    {
      id: 11,
      ...
      image: "https://seepakistantours.com/wp-content/uploads/2018/02/Toyota-Saloon-Coaster-2017-01-390x293.jpg",
      link: "#"
    },
    {
      id: 12,
      ...
      image: "https://seepakistantours.com/wp-content/uploads/2018/02/Daewoo-Bus-2017-01-1-390x293.jpg",
      link: "#"
    }
  ];
  ...
  const carBrands = [
    ...
    "Suzuki", "Ford", "Chevrolet", "Mercedes"
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      <div className="relative h-[100vh] overflow-hidden">
        ...
        <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-4">Rent A Car Islamabad</h1>
                ...
                <a href={car.link} className="block">
                  <div className="relative h-48 overflow-hidden">
                    <img 
                      ...
                      style={{ transform: hoveredCard === car.id ? 'scale(1.05)' : 'scale(1)' }}
                    />
                  ...
                  <div className="p-4">
                    ...
                    <motion.div
                      initial={{ width: 0 }}
                      animate={{ width: hoveredCard === car.id ? '100%' : '0%' }}
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-2/3">
            ...
            >
              ...
              <p className="text-gray-600 mb-4 leading-relaxed">
                <span className="text-prim6bg-primary-600 font-medium">See Pakistan Tours</span> now offers the best Rent a car service in Islamabad for your trips and tours. Islamabad is the second most beautiful capital in the world, and we provide premium services to match its stature.
              </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-white p-4 rounded-lg shadow-sm">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h4 className="font-medium text-gray-800">Affordable Rates</h4>
                        <p className="text-gray-600 text-sm">Cheapest rates in Islamabad & Rawalpindi</p>
                      </div>
                    </div>
                  </div>
                  <div className="bg-white p-4 rounded-lg shadow-sm">
                    <div className="flex items-start gap-3">
                      <div className="text-pri6bg-primary-600 text-2xl">🚗</div>
                      <div>
                        <h4 className="font-medium text-gray-800">Wide Selection</h4>
                        <p className="text-gray-600 text-sm">From economy cars to luxury SUVs</p>
                      </div>
                    </div>
                  </div>
                  <div className="bg-white p-4 rounded-lg shadow-sm">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h4 className="font-medium text-gray-800">Well-Maintained</h4>
                        <p className="text-gray-600 text-sm">Regularly serviced vehicles</p>
                      </div>
                    </div>
                  </div>
                  <div className="bg-white p-4 rounded-lg shadow-sm">
                    <div className="flex items-start gap-3">
                      <div className="text-pri6bg-primary-600 text-2xl">👨‍✈️</div>
                      <div>
                        <h4 className="font-medium text-gray-800">Professional Drivers</h4>
                        <p className="text-gray-600 text-sm">Experienced in all road conditions</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            >
              ...
              >
                <h2 className="text-2xl font-bold text-gray-800">Types Of Cars For Rent In Islamabad</h2>
                <motion.div
              ...
              >
                <div className="pt-2">
                  <p className="text-gray-600 mb-4 leading-relaxed">
                    We own an extensive line of well-maintained vehicles for rent in Islamabad to serve our prestigious clients.
                  </p>
            ...
            <motion.section 
              ...
              className="mb-16"
            >
              <h2 className="text-3xl font-bold text-gray-800 mb-6">Popular Rental Destinations</h2>
              <p className="text-gray-600 mb-6 leading-relaxed">
                We provide car rental services to all major tourist destinations across Pakistan with experienced drivers familiar with all road conditions.
              </p>
                ...
                {popularDestinations.map((destination, index) => (
                  ...
                  >
                    <h3 className="text-xl font-semibold text-gray-800 mb-3">
                      <a href={destination.link} className="hover:text-prim6bg-primary-600">
                        Islamabad to {destination.name}
                      </a>
                    </h3>
                    <p className="text-gray-600 mb-4">
                      Comfortable rides with professional drivers for your journey to {destination.name}.
                    </p>
                    <a 
          ...
          <div className="lg:w-1/3">
            ...
            >
              ...
              <div className="p-4">
                <p className="text-gray-600 mb-4">
                  We provide premium rent-a-car service for Islamabad International Airport with timely pickups and drop-offs.
                </p>
          ...
          <div className="bg-gradient-to-r from-primary-600 to-primary-400 text-white p-8 rounded-xl">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="mb-6 text-lg">
                Experience the comfort and convenience of our premium car rental services in Islamabad. Whether for business or leisure, we have the perfect vehicle for your needs.
              </p>
