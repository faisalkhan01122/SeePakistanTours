...
import SkarduContent from "../section/SkarduContent";
...
const SkarduPage = () => {
  ...
  const tours = [
    ...
    {
      id: 4,
      title: "Fairy Meadows, Skardu, Khaplu & Shigar Valley Tour",
      duration: "10 Days 9 Nights",
      image:
        "https://seepakistantours.com/wp-content/uploads/2019/03/Fairy-meadows-Skardu-10-Days-Tour-580x240.jpg",
      link: "#",
    },
    {
      id: 5,
      title: "Skardu, Basho, Khaplu and Shigar Valley Tour",
      duration: "10 Days 9 Nights",
      image:
        "https://seepakistantours.com/wp-content/uploads/2019/03/Skardu-10-days-tour-580x240.jpg",
      link: "#",
    },
    {
      id: 6,
      title: "Skardu, Shangrila, Khaplu & Shigar Tour",
      duration: "8 Days 7 Nights",
      image:
        "https://seepakistantours.com/wp-content/uploads/2019/02/Skardu-8-days-Tour-580x240.jpg",
      link: "#",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      <div className="relative h-[100vh] overflow-hidden">
        <img
          src="https://seepakistantours.com/wp-content/uploads/2022/04/Destination-Skardu-Valley.jpg"
          alt="Skardu Valley"
        ...
        <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-4">
              Skardu Valley Tours 2025
            </h1>
            <p className="text-xl text-white max-w-2xl mx-auto">
              Explore the breathtaking beauty of Skardu Valley with our
          ...
          <div className="lg:w-2/3">
            ...
            >
              <h2 className="text-3xl font-bold text-gray-800 mb-6">
                Visit Skardu with Affordable Skardu Valley Tour Packages 2025
              </h2>
              ...
              <p className="text-gray-600 mb-4">
                ...
                mountains of the world and is a gateway to some of the world's
                highest peaks in Pakistan. We have a list of adventurous{" "}
                <strong>Skardu Valley tours package 2025</strong> to explore
                this amazing region.
              </p>
            </motion.div>
            ...
            <div className="mb-12">
              <h3 className="text-2xl font-semibold text-gray-800 mb-6">
                Beautiful Places to Visit in Skardu Valley
              </h3>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm mb-8">
              ...
              <p className="text-gray-600 mb-4">
                <strong>Weather in Skardu Valley</strong> remains quite pleasant
                during summers. In other seasons, Skardu valley has cold
                weather. In winter, Skardu valley can reach up to -20°C in the
                main town while in other areas it can go below -30°C.
              </p>
                ...
                <div className="flex-1 min-w-[200px] bg-blue-50 p-4 rounded-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">10°C to 25°C</p>
                    </div>
                  </div>
                </div>
                <div className="flex-1 min-w-[200px] bg-blue-50 p-4 rounded-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">-20°C to 5°C</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            >
              ...
              <div className="p-4">
                ...
                <div className="flex items-center justify-between py-3 border-b border-gray-100">
                  ...
                  <span className="font-medium">4-15 days</span>
                </div>
                <div className="flex items-center justify-between py-3 border-b border-gray-100">
