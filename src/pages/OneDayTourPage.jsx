  ...
  const tours = [
    {
      ...
      duration: "1 Day",
      image: "https://seepakistantours.com/wp-content/uploads/2022/12/Murree-Islamabad-1-day-tour-580x240.jpg",
    ...
    },
    {
      ...
      duration: "1 Day",
      image: "https://seepakistantours.com/wp-content/uploads/2022/12/Taxila-Khanpur-1-day-tour-580x240.jpg",
    ...
    },
    {
      ...
      duration: "1 Day",
      image: "https://seepakistantours.com/wp-content/uploads/2022/12/Khewra-salt-mine-Katas-Raj-1-Day-tour-580x240.jpg",
    ...
    },
    {
      ...
      duration: "1 Day",
      image: "https://seepakistantours.com/wp-content/uploads/2022/12/Islamabad-city-1-day-tour-1-580x240.jpg",
    ...
    },
    {
      ...
      duration: "1 Day",
      image: "https://seepakistantours.com/wp-content/uploads/2022/12/Murree-1-day-tour-580x240.jpg",
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      <div className="relative h-[100vh] overflow-hidden">
        ...
        <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-4">1 Day Tours From Islamabad 2025</h1>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-2/3">
            <motion.div 
              ...
              className="mb-12"
            >
              <h2 className="text-3xl font-bold text-gray-800 mb-6">Experience Pakistan in a Day</h2>
              ...
              <p className="text-gray-600 mb-4">
                Multi-day trips require hotels or resorts, while on a day trip, you can return to your accommodation overnight. If budget is one of your concerns, then our day trips are the perfect solution.
              </p>
              <p className="text-gray-600 mb-6">
                A well-designed day trip will give you a quick and deep insight into these marvelous landscapes, bewitching mountains, and UNESCO World Heritage Sites. Sometimes it doesn't matter how many days you have; what matters is the experiences you can have.
              </p>

              <div className="bg-blue-50 p-6 rounded-xl mb-8">
                <h3 className="text-xl font-semibold text-gray-800 mb-4">Why Choose Our 1 Day Tours?</h3>
                  ...
                  <div className="bg-white p-4 rounded-lg shadow-sm">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-sm">Maximize your experience in minimal time</p>
                      </div>
                    </div>
                  </div>
                  <div className="bg-white p-4 rounded-lg shadow-sm">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h4 className="font-medium text-gray-800">Cost Effective</h4>
                        <p className="text-gray-600 text-sm">No overnight stays needed</p>
                      </div>
                    </div>
                  </div>
                  <div className="bg-white p-4 rounded-lg shadow-sm">
                    <div className="flex items-center gap-3">
                      <div className="text-primary-600 text-2xl">🏞️</div>
                      <div>
                        <h4 className="font-medium text-gray-800">Diverse Experiences</h4>
                        <p className="text-gray-600 text-sm">Nature, history & culture in one day</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            {/* Tours Grid */}
            <div className="mb-12">
              <h3 className="text-2xl font-semibold text-gray-800 mb-6">Featured 1 Day Tours</h3>
            ...
            {/* Popular Tours */}
            <div className="mb-12">
              <h3 className="text-2xl font-semibold text-gray-800 mb-6">Our Hot-Selling 1 Day Tours</h3>
          ...
          <div className="lg:w-1/3">
            ...
            >
              <h3 className="text-xl font-bold text-gray-800 mb-3">Quick Inquiry</h3>
              <p className="text-gray-600 mb-4">Have questions about our 1 day tours? Send us a message!</p>
