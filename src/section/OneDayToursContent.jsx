    ...
    <div className="max-w-6xl mx-auto px-4 py-12">
      ...
      >
        ...
        <motion.p className="text-gray-600 mb-4 leading-relaxed">
          Are you fond of 1 day tours from Islamabad? Any day trip will not only
          help you save time but money as well. In Pakistan's most popular
          tourist destinations, accommodation often comes with a hefty price
          tag.
        </motion.p>

        <motion.p className="text-gray-600 mb-6 leading-relaxed">
          Multi-day trips require hotels or resorts, while on a day trip, you
          can return to your accommodation overnight. If budget is one of your
          concerns, then our day trips are the perfect solution. A well-designed
          day trip will give you a quick and deep insight into these marvelous
      ...
      >
        ...
        >
          <h2 className="text-2xl font-bold text-gray-800">
            Our Hot-Selling One-Day Tour Packages
          </h2>
          ...
          <div className="pt-2">
            ...
            >
              ...
              <p className="text-gray-600 mb-4">
                Sometimes it doesn't matter how many days you have; what matters
                is the experiences you can have. Our carefully crafted
                itineraries ensure you make the most of every minute.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">
                      Knowledgeable local guides enhance your experience
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">
                      More experiences at lower cost
                    </p>
                  </div>
                </div>
              </div>
      ...
      <motion.section initial="hidden" animate="visible" variants={fadeIn}>
        <div className="bg-gradient-to-r from-primary-600 to-primary-400 text-white p-8 rounded-xl">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="mb-6">
              Book now and experience the best of Pakistan in just one day. Our
              tours are perfect for those with limited time who don't want to
              miss out on the country's incredible sights.
            </p>
